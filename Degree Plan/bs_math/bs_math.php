...
if (isset($_GET['search_query']) && !empty($_GET['search_query'])) {
  ...
  FROM courses
  WHERE course_type IN ('Comp Sci General','Math Support') AND (course_code LIKE ? OR title LIKE ?)");
    ...
    <main class="main-content">
      ...
      <section class="content-section">
        ...
        <div class="degree-plan-container">
          <h3 class="section-title">Computer Science Core & Math Support</h3>
          ...
          <div class="course-table">
            ...
            <?php else: ?>
              <div class="table-row">
                ...
                <div class="cell" style="grid-column: span 3;">No Math Support or Comp Sci General courses added yet.</div>
              </div>
            <?php endif; ?>
          </div>
